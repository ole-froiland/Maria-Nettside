...
(function(){
  ...
  // Ensure #erfaring list items reveal one-by-one
  const erfTimeline = document.querySelector('#erfaring .timeline');
  if(erfTimeline){
    erfTimeline.querySelectorAll('.t-item').forEach(li=>{
      li.classList.add('reveal');
      li.setAttribute('data-reveal','');
    });
  }
  ...
  const dict = {
    no: {
      ...
      exp_h: "Erfaring",
      exp1_h: "Salgsleder — Peppes Pizza",
      ...
      exp3_h: "Salgsmedarbeider — Peppes Pizza",
    ...
    en: {
      ...
      exp_h: "Experience",
      exp1_h: "Sales Manager — Peppes Pizza",
      ...
      exp3_h: "Sales Associate — Peppes Pizza",
